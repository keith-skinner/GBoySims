...
// NOT including value pointed to by the HL register (HL)
// Can be used as a replacement to any instruction
...
// (BC) means to derefference BC and same goes for other examples
// 
3
constexpr uint16_t novalue = 0;
