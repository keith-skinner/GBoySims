...
TEST(LR35902_micro, LD_R8_D8) // Register Immediate
{
    ...
    EXPECT_EQ(registers.get<LR35902::Args::A>(), 0x88);
}
...
TEST(LR35902_micro, LD_R16_D16) // Register Immediate
{
    ...
    EXPECT_EQ(registers.records[0], record0);
    EXPECT_EQ(registers.read<LR35902::Args::BC>(), 0x1616);
}
...
TEST(LR35902_micro, LD_R8_R8) // Register Register
{
    ...
    registers.set(LR35902::Args::C{0xBE});
    EXPECT_EQ(memory.records.size(), 0);
    EXPECT_EQ(registers.records.size(), 0);
    EXPECT_EQ(registers.get<LR35902::Args::C>(), 0xBE);
    ...
    EXPECT_EQ(registers.get<LR35902::Args::L>(), 0xBE);
    EXPECT_EQ(registers.get<LR35902::Args::C>(), 0xBE);
}
...
TEST(LR35902_micro, LD_R16_R16) // Register Register
{
    ...
    registers.set(LR35902::Args::HL{0x5678});
    ...
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::HL::Name{}, 0x5678};
    constexpr auto r1 = RegRecord{s_write(), LR35902::Args::SP::Name{}, 0x5678};
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.records[1], r1);
    EXPECT_EQ(registers.read<LR35902::Args::SP>(), 0x5678);
    EXPECT_EQ(registers.read<LR35902::Args::HL>(), 0x5678);
}
...
TEST(LR35902_micro, LD_R8_rR16) // Register RegisterReference
{
    ...
    registers.set(LR35902::Args::HL{0xABCD});
    ...
    EXPECT_EQ(registers.get<LR35902::Args::B>(), 0xBC);
    EXPECT_EQ(memory.get(0xABCD), 0xBC);
    EXPECT_EQ(registers.get<LR35902::Args::HL>(), 0xABCD);
}
...
TEST(LR35902_micro, LD_R8_zR8) // Register RegisterZReference
{
    ...
    registers.set(LR35902::Args::C{0xCD});
    ...
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::C::Name{}, 0xCD};
    constexpr auto r1 = RegRecord{s_write(), LR35902::Args::A::Name{}, 0xBC};
    
    EXPECT_EQ(memory.records[0], m0);
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.records[1], r1);

    EXPECT_EQ(registers.get<LR35902::Args::A>(), 0xBC);
    EXPECT_EQ(memory.get(0xFFCD), 0xBC);
    EXPECT_EQ(registers.get<LR35902::Args::C>(), 0xCD);
}
...
TEST(LR35902_micro, LD_R8_rA16) // Register ImmediateReference
{
    ...
    constexpr auto m0 = MemRecord{s_read(), 0xFFCD, 0xBC};
    constexpr auto r0 = RegRecord{s_write(), LR35902::Args::A::Name{}, 0xBC};
...
TEST(LR35902_micro, LD_zR8_R8) // RegisterZReference Register
{
    ...
    registers.set(LR35902::Args::C{0xCD});
    registers.set(LR35902::Args::A{0xAB});
    ...
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::A::Name{}, 0xAB};
    constexpr auto r1 = RegRecord{s_read(), LR35902::Args::C::Name{}, 0xCD};
    
    EXPECT_EQ(memory.records[0], m0);
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.records[1], r1);

    EXPECT_EQ(registers.get<LR35902::Args::A>(), 0xAB);
    EXPECT_EQ(registers.get<LR35902::Args::C>(), 0xCD);
...
TEST(LR35902_micro, LD_rR16_R8) // RegisterReference Register
{
    ...
    registers.set(LR35902::Args::D{0x14});
    registers.set(LR35902::Args::HL{0x0120});
    ...
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::D::Name{}, 0x14};
    constexpr auto r1 = RegRecord{s_read(), LR35902::Args::HL::Name{}, 0x0120};
    ...
    EXPECT_EQ(registers.get<LR35902::Args::D>(), 0x14);
    EXPECT_EQ(registers.get<LR35902::Args::HL>(), 0x0120);
...
TEST(LR35902_micro, LD_zA8_R8) // ImmediateZReference Register
{
    ...
    registers.set(LR35902::Args::A{0xCD});

    micro.LD(LR35902::Args::zA8{0x34}, LR35902::Args::A{});

    EXPECT_EQ(memory.records.size(), 1);
    EXPECT_EQ(registers.records.size(), 1);
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::A::Name{}, 0xCD};
    constexpr auto m0 = MemRecord{s_write(), 0xFF34, 0xCD};
    EXPECT_EQ(memory.records[0], m0);
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.get<LR35902::Args::A>(), 0xCD);
...
TEST(LR35902_micro, LD_rHL_A_true) // LD rHL+ A
{
    ...
    registers.set(LR35902::Args::HL{0xBEEF});
    registers.set(LR35902::Args::A{0xCD});
    ...
    constexpr auto m0 = MemRecord{s_write(), 0xBEEF, 0xCD};
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::A::Name{}, 0xCD};
    constexpr auto r1 = RegRecord{s_read(), LR35902::Args::HL::Name{}, 0xBEEF};
    constexpr auto r2 = RegRecord{s_write(), LR35902::Args::HL::Name{}, 0xBEEF+1};
    EXPECT_EQ(memory.records[0], m0);
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.records[1], r1);
    EXPECT_EQ(registers.records[2], r2);
    EXPECT_EQ(registers.get<LR35902::Args::A>(), 0xCD);
    EXPECT_EQ(registers.get<LR35902::Args::HL>(), 0xBEEF+1);
    EXPECT_EQ(memory.get(0xBEEF), 0xCD);
}
...
TEST(LR35902_micro, LD_A_rHL_true) // LD A rHL+
{
    ...
    constexpr auto r0 = RegRecord{s_read(),  LR35902::Args::HL::Name{}, 0xBEEF};
    constexpr auto r1 = RegRecord{s_write(), LR35902::Args::A::Name{}, 0xCD};
    constexpr auto r2 = RegRecord{s_write(), LR35902::Args::HL::Name{}, 0xBEEF+1};
    EXPECT_EQ(memory.records[0], m0);
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.records[1], r1);
...
TEST(LR35902_micro, LD_HL_SP_S8_positive) // LD HL, SP+S8
{
    ...
    registers.set(LR35902::Args::SP{0x1234});

    micro.LD(LR35902::Args::HL{}, LR35902::Args::SP{}, LR35902::Args::S8{+0x34});

    EXPECT_EQ(memory.records.size(), 0);
    EXPECT_EQ(registers.records.size(), 4);
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::SP::Name{}, 0x1234};
    constexpr auto r1 = RegRecord{s_write(), LR35902::Args::HL::Name{}, 0x1268};
    constexpr auto r2 = RegRecord{s_read(), LR35902::Args::F::Name{}, 0b0000'0000};
    constexpr auto r3 = RegRecord{s_write(), LR35902::Args::F::Name{}, 0b0000'0000};
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.records[1], r1);
    EXPECT_EQ(registers.records[2], r2);
    EXPECT_EQ(registers.records[3], r3);
    EXPECT_EQ(registers.get<LR35902::Args::HL>(), 0x1268);
    EXPECT_EQ(registers.get<LR35902::Args::SP>(), 0x1234);
    EXPECT_EQ(registers.get<LR35902::Args::F>(), 0b0000'0000);
}
...
TEST(LR35902_micro, LD_HL_SP_S8_negative) // LD HL, SP+S8
{
    ...
    EXPECT_EQ(registers.records.size(), 4);
    constexpr auto r0 = RegRecord{s_read(), LR35902::Args::SP::Name{}, 0x1234};
    constexpr auto r1 = RegRecord{s_write(), LR35902::Args::HL::Name{}, 0x1200};
    constexpr auto r2 = RegRecord{s_read(), LR35902::Args::F::Name{}, 0b0000'0000};
    constexpr auto r3 = RegRecord{s_write(), LR35902::Args::F::Name{}, 0b0000'0000};
    EXPECT_EQ(registers.records[0], r0);
    EXPECT_EQ(registers.records[1], r1);
    EXPECT_EQ(registers.records[2], r2);
    EXPECT_EQ(registers.records[3], r3);
    EXPECT_EQ(registers.get<LR35902::Args::HL>(), 0x1200);
    EXPECT_EQ(registers.get<LR35902::Args::SP>(), 0x1234);
    EXPECT_EQ(registers.get<LR35902::Args::F>(), 0b0000'0000);
}
