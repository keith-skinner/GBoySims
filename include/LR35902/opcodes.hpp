...
// (C) means to dereference the offset given by C from the base address 0xFF00
// (BC) means to dereference the address given by BC or other 16-bit registers
// (a8) means to dereference the offset given by a8 (an immediate) from the base address 0xFF00
// (a16) means to dereference the address given by a16 (an immediate)
// (HL+) means to dereference the addresss given by HL and then increment HL
// (HL-) means to dereference the addresss given by HL and then decrement HL
